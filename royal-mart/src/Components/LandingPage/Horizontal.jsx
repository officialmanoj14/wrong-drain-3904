      ...
      <div className="media_scroller">
        {products.map((product, index) => (
          <div className="media_element">
            ...
            <p className='detail'>{`${product.tittle}`}</p>
            <div className="subtittle"> {`${product.subtittle}`} </div>
            <div className="badgediv">
              <ul className="badgeul">
                <li tabindex="0" role="button" className="badgeli">
                  {`${product.badge}`}
                </li>
              </ul>
            </div>
            <div className="reviewstar">
              <span className="starwrap">
